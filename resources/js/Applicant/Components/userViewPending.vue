            ...
            <section class="px-9 py-5">
                ...
                <div class="grid grid-cols-10 gap-x-4"> 
                    <div class="col-span-4">
                        ...
                        <div class="px-5" :key="reqKey">
                            <li v-for="(req, index) in required">
                                ...
                                <a v-if="req['link'] != 'loading'" @click="alertMessage('Now Downloading '+user.firstname+' '+req['name'])" :href="req['link']" :download="req['fileName']" target="_blank">
                    ...
                    <div class="fixed place-self-end" style="bottom: 10vw">
                        &ensp;&ensp;
                        <button @click="withdrawRequest" class="btn btn-danger" type="button"> Withdraw request </button>
                        &ensp;&ensp;
                        <button @click="uploadToDatabase" class="btn btn-primary" type="button"> Update </button>
                    </div>
        ...
        checkForReqFile(fileName, index){
            if (this.portfolioShowing != true){
                ...
                axios.post('my/getFileAddress', {compiledData}).then(({data})=>{
                    ...
                    console.log(this.required != null)
