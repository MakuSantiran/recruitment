        ...
        <div v-if="compareDate(currOp.submission_deadline)" class="border border-accent bg-white p-5 rounded-lg shadow-lg mb-3 w-9/12 mx-auto">
            ...
            <div class="px-4 grid grid-cols-1 lg:grid-cols-2 gap-2">
                ...
                <div class='col-span-1 lg:col-span-2 mt-2'>
                    ...
                    -->
                    <br>
                    <div v-if="alreadyPending">
                        <b>
                            You are already pending for this opportunity
                        </b>
                    </div>
            ...
            <div class="w-full grid pt-4">
                <div class="place-self-end">
                    ...
                    <button v-if="!(alreadyPending)" @click="showUploadReq" class="btn btn-primary">Apply</button>
...
export default {
    ...
    methods:{
        ...
        checkIfPending(){
            ...
            axios.post('/checkIfPending', {compiledData}).then(({data})=>{
                if (data == 1){
